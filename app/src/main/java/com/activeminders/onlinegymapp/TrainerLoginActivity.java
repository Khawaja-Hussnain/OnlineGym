        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ed_email.getText().toString().equals("")){
                    Toast.makeText(TrainerLoginActivity.this, "Please enter your email", Toast.LENGTH_SHORT).show();
                }else if (ed_password.getText().toString().equals("")){
                    Toast.makeText(TrainerLoginActivity.this, "Please enter your password", Toast.LENGTH_SHORT).show();
                }else
                {
